    ...
    private var actionCardsSection: some View {
        VStack(spacing: 16) {
            ...
            ModernActionCard(
                ...
                iconName: "bell",
                gradient: LinearGradient(
                    colors: [Color(red: 0.26, green: 0.91, blue: 0.48), Color(red: 0.22, green: 0.98, blue: 0.84)],
                    startPoint: .leading,
                    endPoint: .trailing
                ),
                action: {
            ...
            ModernActionCard(
                ...
                iconName: "person",
                gradient: LinearGradient(
                    colors: [Color(red: 0.98, green: 0.44, blue: 0.6), Color(red: 1.0, green: 0.88, blue: 0.25)],
                    startPoint: .leading,
                    endPoint: .trailing
                ),
                action: {
