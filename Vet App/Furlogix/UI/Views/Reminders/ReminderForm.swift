...
struct ReportsReminder: View {
  ...
  var body: some View {
    VStack(spacing: 16) {
      ...
      DatePicker(
        "Select Date & Time", selection: $selectedDateTime,
      ...
      Button(action: {
        ...
        let reminder = Reminder(
          id: -1, frequency: recurrenceOption, startTime: startTimeString, title: reminderTitle,
          message: reminderText, requestId: UUID().uuidString)
