...
final class CsvBuilderTests: XCTestCase {
  ...
  func testBuildCsvWithSingleEntry() {
    let templates = [
      ReportTemplateField(
        id: 1, reportId: 1, name: "Test", fieldType: FieldType.Number, icon: "", units: ""),
      ReportTemplateField(
        id: 2, reportId: 1, name: "Test 2", fieldType: FieldType.Number, icon: "", units: ""),
    ]
    let entries = [
      ReportEntry(
        id: 1, value: "Test val", reportId: 1, templateId: 1, timestamp: "2025-07-10", sent: false),
      ReportEntry(
        id: 2, value: "Test val 2", reportId: 1, templateId: 2, timestamp: "2025-07-10", sent: false
      ),
    ]
  ...
  func testBuildAndWriteCsvCreatesFile() {
    ...
    let fileURL = csvBuilder.buildAndWriteCsv(
      reportName: "TestReport", entries: entries, templates: templates)
  ...
  func testBuildCsvWithMultipleTimestamps() {
    ...
    let entries = [
      ReportEntry(
        id: 1, value: "Test val 3", reportId: 1, templateId: 1, timestamp: "2025-07-09", sent: false
      ),
      ReportEntry(
        id: 2, value: "Test val 4", reportId: 1, templateId: 2, timestamp: "2025-07-09", sent: false
      ),
      ReportEntry(
        id: 3, value: "Test val", reportId: 1, templateId: 1, timestamp: "2025-07-10", sent: false),
      ReportEntry(
        id: 4, value: "Test val 2", reportId: 1, templateId: 2, timestamp: "2025-07-10", sent: false
      ),
    ]
