...
struct ReportTemplateViewModelTest {
  ...
  func GetReportTemplate_ForReport_Success() async throws {
    ...
    mockRepo.fakeReportTemplates = [
      ReportTemplateField(
        reportId: 1, name: "Test 1", fieldType: FieldType.Number, icon: "", units: ""),
      ReportTemplateField(
        reportId: 1, name: "Test 2", fieldType: FieldType.Boolean, icon: "", units: ""),
    ]
  ...
  func GetReportTemplate_ForReport_Fails() async throws {
    ...
    mockRepo.fakeReportTemplates = [
      ...
      ReportTemplateField(
        reportId: 1, name: "Test 2", fieldType: FieldType.Boolean, icon: "", units: ""),
      ReportTemplateField(
        reportId: 2, name: "Test 2", fieldType: FieldType.Text, icon: "", units: ""),
    ]
  ...
  func InsertReportTemplate_Success() async throws {
    let mockRepo = MockReportTemplateRepository()
    let template = ReportTemplateField(
      reportId: 2, name: "Test 1", fieldType: FieldType.Text, icon: "", units: "")
  ...
  func InsertReportTemplate_EmptyName_Fails() async throws {
    let mockRepo = MockReportTemplateRepository()
    let template = ReportTemplateField(
      reportId: 2, name: "", fieldType: FieldType.Text, icon: "", units: "")
  ...
  func UpdateReportTemplate_Success() async throws {
    let mockRepo = MockReportTemplateRepository()
    let template = ReportTemplateField(
      reportId: 2, name: "test update", fieldType: FieldType.Text, icon: "", units: "")
