...
class ReminderViewModelTestAsync: XCTestCase {
  ...
  func test_insertReminder_Success() {
    ...
    let vm = ReminderViewModel(
      remindersRepository: mockRepo, userNotificationService: mockNotificationService)

    let reminder = Reminder(
      id: 1, frequency: "once", startTime: "2025-07-10, 11:00 AM", title: "Test", message: "Test",
      requestId: "abc")
  ...
  func test_insertReminder_FailureToSchedule() {
    ...
    let reminder = Reminder(
      id: 2, frequency: "once", startTime: "2025-07-10, 11:00 AM", title: "Test", message: "Test",
      requestId: "abc")
