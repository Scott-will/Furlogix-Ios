...
struct ReminderViewModelTest {
  ...
  func getReminders_Success() {
    ...
    let reminder = Reminder(
      id: 1, frequency: "abcd", startTime: "abcd", title: "abcd", message: "abcd", requestId: "abcd"
    )
    let reminder2 = Reminder(
      id: 2, frequency: "abcde", startTime: "abcde", title: "abcde", message: "abcde",
      requestId: "abcd")
  ...
  func insertReminder_InvalidReminder_MissingTitle_Fails() {
    let mockRepo = MockReminderRepository()
    let reminder = Reminder(
      id: 1, frequency: "abcd", startTime: "abcd", title: "", message: "abcd", requestId: "abcd")
    let vm = ReminderViewModel(remindersRepository: mockRepo)
    vm.insertReminder(reminder: reminder)
    #expect(vm.errorMessage != nil)
  }
  ...
  func insertReminder_InvalidReminder_MissingMessageFails() {
    let mockRepo = MockReminderRepository()
    let reminder = Reminder(
      id: 1, frequency: "abcd", startTime: "abcd", title: "abcd", message: "", requestId: "abcd")
    let vm = ReminderViewModel(remindersRepository: mockRepo)
    vm.insertReminder(reminder: reminder)
    #expect(vm.errorMessage != nil)
  }
  ...
  func insertReminder_InvalidReminder_MissingFrequency_Fails() {
    let mockRepo = MockReminderRepository()
    let reminder = Reminder(
      id: 1, frequency: "", startTime: "abcd", title: "abcd", message: "abcd", requestId: "abcd")
    let vm = ReminderViewModel(remindersRepository: mockRepo)
    vm.insertReminder(reminder: reminder)
    #expect(vm.errorMessage != nil)
  }
