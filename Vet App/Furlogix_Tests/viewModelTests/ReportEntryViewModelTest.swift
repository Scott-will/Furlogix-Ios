...
struct ReportEntryViewModelTests {
    ...
    func testLoadReportEntryList_success() {
        ...
        mockRepo.fakeEntries = [
            ReportEntry(id: 1, value: "Temp", reportId: 10, templateId: 1, timestamp: "2024-07-10", sent: false),
            ReportEntry(id: 2, value: "Weight", reportId: 10, templateId: 2, timestamp: "2024-07-10", sent: false)
        ]
 ...
 @Test
    func testLoadGroupedEntries_correctGrouping() {
        ...
        mockRepo.fakeEntries = [
            ReportEntry(id: 1, value: "Val1", reportId: 1, templateId: 1, timestamp: "2024-07-10", sent: false),
            ReportEntry(id: 2, value: "Val2", reportId: 1, templateId: 2, timestamp: "2024-07-10", sent: false),
            ReportEntry(id: 3, value: "Val3", reportId: 1, templateId: 3, timestamp: "2024-07-11", sent: false),
            ReportEntry(id: 4, value: "Val4", reportId: 1, templateId: 4, timestamp: "2024-07-11", sent: false),
            ReportEntry(id: 5, value: "Val5", reportId: 1, templateId: 5, timestamp: "2024-07-12", sent: false)
        ]
